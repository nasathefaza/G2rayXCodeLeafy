...
generate_link() {
    ...
    echo "vless://${UUID}@94.130.50.12:${XRAY_PORT}?encryption=none&security=tls&sni=${PORT_DOMAIN}&fp=chrome&alpn=h2&insecure=1&allowInsecure=1&type=xhttp&host=${PORT_DOMAIN}&path=%2F&mode=packet-up#G2rayXCodeLeafy"
}
